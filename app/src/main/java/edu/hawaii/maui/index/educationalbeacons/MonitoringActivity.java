...
public class MonitoringActivity extends AppCompatActivity implements BootstrapNotifier, RangeNotifier,BeaconConsumer {
    ...
    public void didRangeBeaconsInRegion(Collection<Beacon> beacons, Region region) {
        for(Beacon beacon : beacons){
            Log.d(TAG,"LET'S HOPE WE GET THIS");
        }
    }
